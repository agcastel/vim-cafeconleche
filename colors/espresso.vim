...
highlight Folded          term=standout cterm=bold ctermfg=6 ctermbg=0 gui=bold guifg=#2880bb guibg=#1c0a08
highlight FoldColumn      term=standout cterm=bold ctermfg=6 ctermbg=0 gui=bold guifg=#2880bb guibg=#1c0a08
